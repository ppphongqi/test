<template>
    <div class="wrapper">
        ...
        <div class="top"  v-if="login">
            ...
            <!--广告位-->
            <div class="open adv">
                <img src="./images/biaoyu.jpg" class="biaoyu">
            </div>
        </div>
...
<script>
    ...
    import {reqCollect, reqUserFabu} from "../api";
    ...
    export default {
        ...
        computed:mapGetters(['login','username','buynum','fabunum','colnum','userInfo','userFabu']),
                ...
                if (!this.isLogin) {
                    ...
                    // this.$router.push({path: '/myfabu'})
                        ...
                        if(result.status === "88"){
                            ...
                            this.$store.dispatch('getUserFabu');
                            console.log(this.$store.state.userFabu);
                            this.$router.push({path:'/myfabu'})
                        }
